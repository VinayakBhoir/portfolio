                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <a
                                ...
                                className="text-[var(--text-secondary)] hover:text-[var(--accent-primary)] transition-colors duration-200 text-sm"
                            >
                                {personalInfo.email}
                            </a>
                        </div>
                        ...
                        <div className="flex space-x-4">
                            {socialLinks.map((link) => (
                                <a
                                    ...
                                    className="text-[var(--text-secondary)] hover:text-[var(--accent-primary)] transition-all duration-200 hover:scale-110"
